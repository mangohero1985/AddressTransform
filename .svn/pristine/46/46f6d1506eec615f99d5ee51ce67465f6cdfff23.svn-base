...
import Processing.CosineDistance;
...
public class no {
	...
	public double Cosine_Similarity_Score(String Text1, String Text2) {
		...
		Hashtable<String, values> word_freq_vector = new Hashtable<String, no.values>();
	 ...
	 {
	 CosineDistance cs1 = new CosineDistance();
	
	 System.out.println("[Word # VectorA # VectorB]");
	 double sim_score = cs1.Cosine_Similarity_Score("r u k a s u b i r u h i g a s h i j y u j o ", "h i g a s h i j u j o d a i ");
