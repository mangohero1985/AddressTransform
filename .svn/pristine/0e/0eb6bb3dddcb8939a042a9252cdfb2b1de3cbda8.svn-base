...
public class CosineDistance {
	...
	public double Cosine_Similarity_Score(String Text1, String Text2) {
		...
		Hashtable<String, values> word_freq_vector = new Hashtable<String, CosineDistance.values>();
	...
	// double sim_score = cs1.Cosine_Similarity_Score("a r a t a",
	// "a r a t a m a c h i ");
	...
	public double CosineDistance(String s1, String s2) {
		...
		double sim_score = cs1.Cosine_Similarity_Score(s1, s2);
		return sim_score;
	}
}